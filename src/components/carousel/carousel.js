...
export default class Carousel extends React.Component {
  ...
  render() {
    ...
    return (
      <section id="carousel" {...css(componentStyles.carouselContainer)}>
        ...
        <div id="navButtons" {...css(componentStyles.navigationButtons)}>
          <span
            {...css(componentStyles.navigationButton)}
            {...css(componentStyles.navbuttonPrev)}
          ...
          <span
            {...css(componentStyles.navigationButton)}
            {...css(componentStyles.navbuttonNext)}
        ...
        <div id="mobileNavButtons" {...css(componentStyles.mobileNavigations)}>
          <span
            {...css(componentStyles.mobilePrevButton)}
            onClick={this.handlePrevious}
          >
            <img src={ArrowIcon} />
          </span>
          <span
            {...css(componentStyles.mobileNextButton)}
            onClick={this.handleNext}
          >
            <img src={ArrowIcon} />
          </span>
